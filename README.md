...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-na5mot0.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-na5mot0.containers.anotherwebservice.com/
...
```
git clone git@github.com:SidahmedFrioui/container-na5mot0.git
cd container-na5mot0
```
...
```
docker attach container-na5mot0
```
